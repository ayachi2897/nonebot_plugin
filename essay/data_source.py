...
commands = {
    "ussrjoke": {
        "aliases": {"yuki苏联笑话sssssssssssssss"},
        "func": get_ussrjoke,
        "help": "yuki苏联笑话 {要讽刺的事} {谁提出来的} {有助于什么} {针对的是谁} {起作用范围}",
        "arg_num": 5,
    },
    "cpstory": {
        "aliases": {"yukicp文", "cp文","yukiCP文","CP文"},
        "func": get_cp_story,
        "help": "yukicp文 {人物A} {人物B}",
        "arg_num": 2,
    },
    "marketing": {
        "aliases": {"yuki营销号ssssssssssssssssss"},
        "func": get_marketing_article,
        "help": "yuki营销号 {主题} {描述} {另一种描述}",
        "arg_num": 3,
    },
    "chickensoup": {
        "aliases": {"yuki毒鸡汤"},
    ...
    "headpoem": {
        "aliases": {"yuki藏头诗sssssssssss"},
        "func": get_head_poem,
        "help": "yuki藏头诗 {keyword}",
        "arg_num": 1,
    },
}
